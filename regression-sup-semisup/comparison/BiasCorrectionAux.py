    ...
    for k in range(0, len(dataset_states1)):
        for r in range(0, len(percentages_unsupervised)):
            ...
            for i in range(0, len(weight_states)):
                ...
                model.save_weights(filepath=save_location_model + 'weights_fuzzy_model_' + str(i) + '_dataset_' + str(k) + '_percentage_' + str(r) + '/weights_fuzzy_model_initial_' + str(i) + '_dataset_' + str(k) + '_percentage_' + str(r))
