...
name_experiment = 'BiasCorrection_DiffSize'
...
if constrained_dataset:
    ...
    print('-----------------')
    aux.perform_experiment_different_training_sizes(directory_dataset, name_dataset, extension_dataset, initial_learning_rate, test_size, validation_size,
                                                    train_size, max_num_epochs, max_epoch_constraints, batch_size, acceptable_sat_ratio, max_bumps_con,
                                                    max_time_after_bumps_con, max_constant_perf_con, max_restarts_con, random_state=random_seed,
                                                    ...
                                                    constrained=constrained_dataset,
                                                    unconstrained=False, fuzzy=False, margin=margin)
...
if unconstrained_dataset:
    ...
    aux.perform_experiment_different_training_sizes(directory_dataset, name_dataset, extension_dataset, initial_learning_rate, test_size, validation_size,
                                                    ...
                                                    number_weight_initializations=number_weight_initializations, name_experiment=name_experiment,
                                                    constrained=False,
                                                    unconstrained=unconstrained_dataset, fuzzy=False, margin=margin)
