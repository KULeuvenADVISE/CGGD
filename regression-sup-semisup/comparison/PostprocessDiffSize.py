...
exp_latex_code_loss_bias_train, exp_latex_code_satisfaction_bias_train, results_loss_bias_train, results_sr_bias_train = construct_results_train(name_experiment='BiasCorrection_DiffSize',
...
used_train_sizes = [1, 0.75, 0.5, 0.25, 0.1]
exp_latex_code_loss_bias_val, exp_latex_code_satisfaction_bias_val, results_loss_bias_val, results_sr_bias_val = construct_results_val(name_experiment='BiasCorrection_DiffSize',
                                                                               name_dataset='Sample_Bias_correction_ucl_reduced',
                                                                               train_sizes=[str(sizes) for sizes in used_train_sizes],
                                                                               directory_experiment='./Results',
                                                                               number_weight_initializations=4,
...
used_train_sizes = [1, 0.75, 0.5, 0.25, 0.1]
exp_latex_code_loss_bias_test, exp_latex_code_satisfaction_bias_test, results_loss_bias_test, results_sr_bias_test = construct_results_test(name_experiment='BiasCorrection_DiffSize',
                                                                               name_dataset='Sample_Bias_correction_ucl_reduced',
                                                                               train_sizes=[str(sizes) for sizes in used_train_sizes],
                                                                               directory_experiment='./Results',
                                                                               number_weight_initializations=4,
...
used_train_sizes = [1, 0.75, 0.5, 0.25, 0.1]
exp_latex_code_loss_income_train, exp_latex_code_satisfaction_income_train, results_loss_income_train, results_sr_income_train = construct_results_train(name_experiment='FamilyIncome_DiffSize',
...
used_train_sizes = [1, 0.75, 0.5, 0.25, 0.1]
exp_latex_code_loss_income_val, exp_latex_code_satisfaction_income_val, results_loss_income_val, results_sr_income_val = construct_results_val(name_experiment='FamilyIncome_DiffSize',
                                                                               name_dataset='Sample Family Income and Expenditure Reduced',
                                                                               train_sizes=[str(sizes) for sizes in used_train_sizes],
                                                                               directory_experiment='./Results',
                                                                               number_weight_initializations=4,
...
used_train_sizes = [1, 0.75, 0.5, 0.25, 0.1]
exp_latex_code_loss_income_test, exp_latex_code_satisfaction_income_test, results_loss_income_test, results_sr_income_test = construct_results_test(name_experiment='FamilyIncome_DiffSize',
                                                                               name_dataset='Sample Family Income and Expenditure Reduced',
                                                                               train_sizes=[str(sizes) for sizes in used_train_sizes],
                                                                               directory_experiment='./Results',
                                                                               number_weight_initializations=4,
