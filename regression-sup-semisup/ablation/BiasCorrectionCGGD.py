...
def train_model_adaptive_rescale(model, input_dim, output_dim, optimizer, list_bound_constraints, train_number, train_dataset,
                                  ...
                                  save_location_model, save_file_model):
    """Train the given model with CGGD with adaptive rescale factor.
...
def train_model_semi_sup(model, input_dim, output_dim, optimizer, list_bound_constraints, train_number, train_dataset,
    ...
    """Train the given model semi-supervised with CGGD.
