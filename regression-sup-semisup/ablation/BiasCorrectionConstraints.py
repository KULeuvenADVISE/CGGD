...
# Next_Tmax (0th output variable) is larger than (or equal) the Next_Tmin (1st output variable)
# both output variables have 2 bound constraints. The upper bound is the maximum of Next_Tmax in the dataset with some margin and the lower bound is the minimum of Next_Tmin in the dataset with some margin. The margin allows for some flexibility outside of the dataset available.
