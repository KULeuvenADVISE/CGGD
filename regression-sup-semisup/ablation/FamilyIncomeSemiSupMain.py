...
name_experiment = 'FamilyIncome_SemiSup_DiffRescaleFactors'
...
if constrained_dataset:
    ...
    print('-----------------')
    aux.perform_experiment_semi_sup_different_rescale_factors(directory_dataset=directory_dataset, name_dataset=name_dataset,
                                                              ...
                                                              max_time_after_bumps_con=max_time_after_bumps_con,
                                                              max_constant_perf_con=max_constant_perf_con, max_restarts_con=max_restarts_con,
                                                              random_state=random_seed, number_dataset_realizations=number_dataset_realizations,
                                                              number_weight_initializations=number_weight_initializations,
                                                              name_experiment=name_experiment, margin=margin,
                                                              percentages_unsupervised=percentage_data_unsupervised, rescale_factors=rescale_factors)
