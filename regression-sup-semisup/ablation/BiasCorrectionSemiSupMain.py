...
name_experiment = 'BiasCorrection_SemiSup_DiffRescaleFactors'
...
if constrained_dataset:
    ...
    print('-----------------')
    aux.perform_experiment_semi_sup_different_rescale_factors(directory_dataset, name_dataset, extension_dataset, initial_learning_rate, test_size,
                                                              validation_size, max_num_epochs, max_epoch_constraints, batch_size,
                                                              acceptable_sat_ratio, max_bumps_con, max_time_after_bumps_con, max_constant_perf_con,
