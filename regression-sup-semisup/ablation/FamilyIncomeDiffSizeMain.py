...
name_experiment = 'FamilyIncome_DiffSize_DiffRescaleFactors'
...
if constrained_dataset:
    ...
    print('-----------------')
    aux.perform_experiment_different_training_sizes_different_rescale_factors(directory_dataset=directory_dataset, name_dataset=name_dataset,
                                                                              ...
                                                                              max_constant_perf_con=max_constant_perf_con,
                                                                              ...
                                                                              name_experiment=name_experiment, margin=margin, train_size=train_size,
