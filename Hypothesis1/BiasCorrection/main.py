...
# dataset
directory_dataset = '../DataSets/'  # relative path to file with dataset
...
name_experiment = 'Hypothesis1_BiasCorrection'
...
if constrained_dataset:
    ...
    aux.perform_experiment_different_training_sizes(directory_dataset=directory_dataset, name_dataset=name_dataset,
                                                    ...
                                                    name_experiment=name_experiment, constrained=constrained_dataset,
                                                    unconstrained=False, fuzzy=False, margin=margin, train_size=train_size)
