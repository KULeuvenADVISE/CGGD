...
if run_bc:
    ...
    print('Bias Correction data set has been preprocessed.')
else:
    print('Bias Correction data set is not considered.')
...
if run_fi:
    ...
    print('Family Income data set has been preprocessed.')
else:
    print('Family Income data set is not considered.')
