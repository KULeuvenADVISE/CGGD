...
def sample_train(path_data, percentage, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox'], seed=5):
    random.seed(seed)
...
def copy_val(path_data, percentage, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox']):
...
if __name__ == "__main__":
    ...
    # repository.
    sample_train(path_data='./data/prostate', percentage=0.1, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox'], seed=5)
    copy_val(path_data='./data/prostate', percentage=0.1, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox'])
    sample_train(path_data='./data/prostate', percentage=0.5, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox'], seed=5)
    copy_val(path_data='./data/prostate', percentage=0.5, subfolders=['box', 'centroid', 'erosion', 'gt', 'img', 'random', 'thickbox'])
